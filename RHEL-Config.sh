...
sudo yum install -y cmus util-linux-user i3 xedit.x86_64 i3-gaps-4.19.1-3.fc36 --allowerasing
sudo dnf install 0y https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-$(rpm -E %fedora).noarch.rpm https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-$(rpm -E %fedora).noarch.rpm
